...
@section('content')
    {{-- Filter Bar --}}
    <form method="GET" class="bg-gray-200 px-6 py-3">
        <div class="flex flex-wrap gap-3">
            ...
            {{-- Brand --}}
            <select name="brand" onchange="this.form.submit()" class="px-3 py-1 rounded border text-sm">
            ...
            @forelse ($products as $product)
                <div class="bg-white border rounded-lg p-3 hover:shadow transition">
                    ...
                    <a href="{{ route('gadget.show', $product->id) }}"
                        class="block bg-white border rounded-lg p-3 hover:shadow transition">
