...
@push('scripts')
    <script>
        ...
        function removeExisting(id) {
            // Panggil AJAX Delete Image langsung (lebih aman)
            // Atau gunakan hidden input seperti kode Anda sebelumnya
            if (confirm('Hapus gambar ini permanen?')) {
                // Buat form dinamis untuk delete image
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = "{{ url('admin/raditya/image') }}/" + id; // Sesuaikan route destroyImage
