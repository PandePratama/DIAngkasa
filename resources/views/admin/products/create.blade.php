                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="price_3_months" value="{{ old('price_3_months') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="price_6_months" value="{{ old('price_6_months') }}"
                                class="form-control" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="price_9_months" value="{{ old('price_9_months') }}"
                                class="form-control" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="price_12_months" value="{{ old('price_12_months') }}"
                                class="form-control" step="0.01">
                        </div>
                    </div>
                </div>
